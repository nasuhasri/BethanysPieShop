...
{
    // return the mock version of IPieRepository and ICategoryRepository
    public static Mock<IPieRepository> GetPieRepository()
    {
        ...
        // do setup where when someone ask all pies, they will get back this list of pies
        ...
        // when someone ask pie passing an integer, return the first pies of the list
